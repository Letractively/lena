...
<xsl:template match="f:resource">
	<div>
  	...
  	<div style="padding: 5px 0px 5px 0px; font-weight: bold;">
			...
			<a onclick='setHrefs()' href='?resource={fn:encode-for-uri($resource)}' class='tooltip' title='Lens: DEFAULT :: Resource: {$resource}'><img src='public/images/rdf_icon.gif' style='width: 16px; border: 0px; margin: 0px 2px;' alt='Icon.' /></a>
				...
				<!-- Link to linked data -->
				<xsl:if test="fn:starts-with($resource, 'http://')">
					<xsl:if test="fn:not(fn:codepoint-equal(functx:substring-after-last($resource, '.'), 'htm') or fn:codepoint-equal(functx:substring-after-last($resource, '.'), 'html') or fn:codepoint-equal(functx:substring-after-last($resource, '.'), 'php') or
															 fn:codepoint-equal(functx:substring-after-last($resource, '.'), 'org') or fn:codepoint-equal(functx:substring-after-last($resource, '.'), 'com') or fn:codepoint-equal(functx:substring-after-last($resource, '.'), 'de') or fn:codepoint-equal(functx:substring-after-last($resource, '.'), 'edu') or 
															 fn:codepoint-equal(functx:substring-after-last($resource, '.'), 'jpg') or fn:codepoint-equal(functx:substring-after-last($resource, '.'), 'jpeg') or fn:codepoint-equal(functx:substring-after-last($resource, '.'), 'png'))">
